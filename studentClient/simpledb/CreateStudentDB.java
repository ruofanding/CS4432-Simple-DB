...
public class CreateStudentDB {
	public static void main(String[] args) {
		...
		try {
			...
			String[] deptvals = { "(10, 'compsci')", "(20, 'math')",
					"(30, 'drama')" };
			...
			String[] coursevals = { "(12, 'db systems', 10)",
					"(22, 'compilers', 10)", "(32, 'calculus', 20)",
					"(42, 'algebra', 20)", "(52, 'acting', 30)",
					"(62, 'elocution', 30)" };
			...
			String[] sectvals = { "(13, 12, 'turing', 2004)",
					"(23, 12, 'turing', 2005)", "(33, 32, 'newton', 2000)",
			...
			String[] enrollvals = { "(14, 1, 13, 'A')", "(24, 1, 43, 'C' )",
					"(34, 2, 43, 'B+')", "(44, 4, 33, 'B' )",
					"(54, 4, 53, 'A' )", "(64, 6, 53, 'A' )" };
